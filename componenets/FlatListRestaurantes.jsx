...
// Componente funcional que representa un elemento de la lista de restaurantes
  ...
  return (
    <TouchableOpacity onPress={handlePress}>
      <ImageBackground source={{ uri: image }} style={styles.item}>
        {/* Muestra el título sobre el fondo de imagen */}
        {title && (
...
// Componente principal que muestra una lista horizontal de restaurantes
const Restaurantes = () => {
  const [store] = useContext(storeContext);

  // Extrae la lista plana de restaurantes del contexto
  const flatRestaurante = store.restaurantesFlat;

  // Retorna una SafeAreaView con una FlatList de elementos de restaurante
  return (
    <SafeAreaView style={styles.container}>
      <FlatList
        data={flatRestaurante}
        renderItem={({ item }) => (
